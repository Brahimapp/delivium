...
echo sprintf( esc_html__( 'Hi %s,', 'delivium' ), esc_html( $user_info->first_name ) ) . "\n\n";
/* translators: %s: Order number */
echo sprintf( esc_html__( 'Order #%s has been assigned to you.', 'delivium' ), esc_html( $order->get_id() ) ) . "\n\n";
