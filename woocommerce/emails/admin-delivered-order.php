...
<p><?php printf( esc_html__( 'Order #%s has been delivered:', 'delivium' ), esc_html( $order->get_id() ) ); ?></p>
...
if ( '' !== $delivium_driver_note ){
	echo '<p><b>' . esc_html( __( 'Driver note', 'delivium' ) ) . ':</b><br> ' . $delivium_driver_note . "</p>";
}
...
$delivium_order_signature = $order->get_meta('delivium_order_last_signature');
	...
	echo '<p><b>';
	echo esc_html( __( 'Signature', 'delivium' ) ) . '</b><br>';
	echo '<a href="' . esc_attr( $delivium_order_signature ) . '" target="_blank"><img style="max-width:100%" src="' . esc_attr( $delivium_order_signature ) . '"></a>';
	echo '</p>';
}
...
// Photo
	...
	echo '<p><b>';
	echo esc_html( __( 'Delivery image', 'delivium' ) ) . '</b><br>';
	echo '<a href="' . esc_attr( $delivium_order_delivery_image ) . '" target="_blank"><img style="max-width:100%" src="' . esc_attr( $delivium_order_delivery_image ) . '"></a>';
	echo '</p>';
}
