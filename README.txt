=== Delivium - Local Delivery Management for WooCommerce ===
Contributors: delivium
Donate link: https://delivium.top
...
== Description ==
Developed by [Delivium](https://delivium.top/) | [Premium](https://delivium.top/local-delivery-drivers-for-woocommerce-premium/) | [Documents](https://delivium.top/docs/local-delivery-drivers-for-woocommerce-premium/)
...
## DELIVIUM - LOCAL DELIVERY MANAGEMENT FOR WOOCOMMERCE
Delivium lets store owners assign delivery drivers to orders. And lets delivery drivers manage their deliveries with a mobile-friendly panel.
...
## * PREMIUM FEATURES
Check out the [Local Delivery Drivers for WooCommerce Premium](https://delivium.top/local-delivery-drivers-for-woocommerce-premium/) plugin.
...
* [Delivery Drivers Manager](https://delivium.top/delivery-drivers-manager/)
* [Delivery Drivers for Vendors](https://delivium.top/delivery-drivers-for-woocommerce-multi-vendor-marketplace/)
* [Pickup Locations for Delivery Drivers](https://delivium.top/pickup-locations-for-delivery-drivers/)
* [Pickup & Delivery from Customer Locations for WooCommerce](https://delivium.top/pickup-and-delivery-from-customer-locations-for-woocommerce/)
* [Autocomplete Address and Location Picker for WooCommerce](https://delivium.top/autocomplete-address-and-location-picker-for-woocommerce-premium/)
...
= 1.7.0 =
* Fix: Route address.
* Dev: The function delivium_format_address has been modified and removed from the store class.
...
* Dev: Add new delivium_pickup_type filter to allow tuning of pickup type.
* Dev: Add new get_pickup_phone function to get the pickup phone number.
* Dev: Add new delivium_pickup_phone filter to allow tuning of pickup phone number.
* Dev: Add new delivium_pickup_location filter to allow tuning of pickup location.
* Dev: Update delivium_pickup_address function.
...
* Dev: New filter delivium_get_order_pickup_geocode to allow tuning of pickup location geocode.
* Dev: New function delivium_get_app_mode.
* Dev: New function delivium_get_map_language.
* Dev: New function delivium_get_map_center.
